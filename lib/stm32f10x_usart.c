...
/*********************************************************************************************
* name			:		USART_Init
* func			:		将USART根据结构体配置初始化
* para			:		USART_TypeDef* , USART_InitTypeDef*
* ret				:		none
* comment		:	
*********************************************************************************************/
void USART_Init(USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct)
{
  ...
  /* The hardware flow control is available only for USART1, USART2 and USART3 */
	/*硬件流控制位只对USART1、2、3有效*/
  if (USART_InitStruct->USART_HardwareFlowControl != USART_HardwareFlowControl_None)
  {
    assert_param(IS_USART_123_PERIPH(USARTx));
  }
	
	/*将usart基地址定义为结构体定义的基地址*/
...
* func			:		USART时钟相关初始化
* para			:		USART_TypeDef* USARTx, USART_ClockInitTypeDef* USART_ClockInitStruct
* ret				:		none
* comment		:	
*********************************************************************************************/
...
* func			:		USART时钟结构体初始化
* para			:		USART_ClockInitTypeDef* USART_ClockInitStruct
* ret				:		none
* comment		:	
*********************************************************************************************/
...
* name			:		USART_Cmd
* func			:		使能或失能USART串口
* para			:		USART_TypeDef* USARTx, FunctionalState NewState
* ret				:		none
* comment		:	
*********************************************************************************************/
